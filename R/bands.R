...
#' Simple interactive chromosome maps
#'
#' @param df A data frame of chromosome segments
#' @param bands Specificy which chomosomes to show and in what order
#' @param labels Set true to show segment labels
